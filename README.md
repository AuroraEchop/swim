...
这是一个航运业务课程设计项目，采用前后端分离架构。当前已完成 Spring Boot 后端接口、MySQL 表结构、接口文档、DTO 文档、本地开发环境配置和前端页面设计；下一阶段适合按前端设计文档开始 Vue 3 页面开发。
...
`frontend/` 目录将在前端实现阶段创建，页面与路由按 `前端页面设计文档.md` 执行。
