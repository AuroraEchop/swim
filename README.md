...
前端当前已具备登录页、后台主布局、路由守卫、API 客户端、首页统计骨架和模块占位页。页面风格以 `DESIGN.md` 为准：浅色后台管理界面，深海青作为主色，整体保持正式、清晰、适合学校课程设计演示。
...
继续按 `前端页面设计文档.md` 和 `DESIGN.md` 实现业务页面：先完成字典下拉与通用列表表单模式，再依次接入船舶、船员、运输任务、结算、用户角色接口。
